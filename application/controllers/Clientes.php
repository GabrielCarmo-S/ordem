	...
	class Clientes extends CI_Controller{
		...
		public function add(){
			...
			if ($cliente_tipo == 1) {
				...
				$this->form_validation->set_rules('cliente_cnpj','','trim|required|exact_length[14]|is_unique[clientes.cliente_cpf_cnpj]|callback_valida_cnpj');
			...
			$this->session->set_flashdata('sucesso', 'Cliente salvo com sucesso');
			redirect('clientes');
