...
class Fornecedores extends CI_Controller{
	...
	public function add(){
		...
		$this->form_validation->set_rules('fornecedor_razao','','trim|required|min_length[5]|max_length[45]|is_unique[fornecedores.fornecedor_razao]');
		$this->form_validation->set_rules('fornecedor_nome_fantasia','','trim|required|min_length[5]|max_length[45]|is_unique[fornecedores.fornecedor_nome_fantasia]');
		...
		$this->form_validation->set_rules('fornecedor_telefone','','trim|max_length[14]|is_unique[fornecedores.fornecedor_telefone]');
		
		$this->form_validation->set_rules('fornecedor_celular','','trim|max_length[15]|is_unique[fornecedores.fornecedor_celular]');
		...
		if ($this->form_validation->run()) {
			...
			$this->session->set_flashdata('sucesso', 'fornecedor salvo com sucesso');
	...
	public function edit($fornecedor_id = NULL){
		...
		if (!$fornecedor_id || !$this->core_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id))) {
			...
			$this->form_validation->set_rules('fornecedor_razao','','trim|required|min_length[5]|max_length[200]|callback_check_razao_social');
			$this->form_validation->set_rules('fornecedor_nome_fantasia','','trim|required|min_length[5]|max_length[45]|callback_check_nome_fantasia');
			...
			$this->form_validation->set_rules('fornecedor_telefone','','trim|required|max_length[15]|callback_check_telefone');
