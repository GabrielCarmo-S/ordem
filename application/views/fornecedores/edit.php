              ...
              <form method="POST" name="form_edit">
                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row">
                   <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                       ...
                       <input type="text" class="form-control cnpj" name="fornecedor_ie" placeholder="I.E do Fornecedor" value="<?php echo $fornecedor->fornecedor_ie; ?>">
                       <?php echo form_error('fornecedor_ie', '<small class="form-text text-danger">','</small>'); ?>
                    </div>
                    <div class="col-md-4">
                       <label>Telefone:</label>
                       <input type="text" class="form-control sp_celphones" name="fornecedor_telefone" placeholder="Telefone" value="<?php echo $fornecedor->fornecedor_telefone; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                       <label>Email:</label>
                       <input type="email" class="form-control" name="fornecedor_email" placeholder="Email" value="<?php echo $fornecedor->fornecedor_email; ?>">
                       <?php echo form_error('fornecedor_email', '<small class="form-text text-danger">','</small>'); ?>
                    </div>
                    <div class="col-md-4">
                       <label>Atendente:</label>
                       <input type="text" class="form-control" name="fornecedor_contato" placeholder="Atendente" value="<?php echo $fornecedor->fornecedor_contato; ?>">
                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-3">
                       ...
                       <input type="text" class="form-control" name="fornecedor_numero_endereco" placeholder="Número Endereço:" value="<?php echo $fornecedor->fornecedor_numero_endereco; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-2">
                       <label>UF:</label>
                       <input type="text" class="form-control" name="fornecedor_estado" placeholder="UF" value="<?php echo $fornecedor->fornecedor_estado; ?>">
                ...
                <fieldset class="mt-4 border p-2 mb-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      ...
                      <textarea class="form-control" name="fornecedor_obs" placeholder="Observações:" value=""><?php echo $fornecedor->fornecedor_obs; ?></textarea>
