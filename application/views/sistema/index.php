            ...
            <div class="card-body">
              <form method="POST" name="form_edit">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-3">
                     <label>CNPJ:</label>
                     <input type="text" class="form-control cnpj" name="sistema_cnpj" placeholder="Seu CNPJ" value="<?php echo $sistema->sistema_cnpj; ?>">
                     <?php echo form_error('sistema_cnpj', '<small class="form-text text-danger">','</small>'); ?>
                  </div>

                   <div class="col-md-3">
                     <label>Inscrição Estadual:</label>
                     <input type="text" class="form-control" name="sistema_ie" placeholder="Sua Inscrição Estadual" value="<?php echo $sistema->sistema_ie; ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-3">
                     ...
                     <input type="text" class="form-control sp_celphones" name="sistema_telefone_movel" placeholder="Telefone Movel" value="<?php echo $sistema->sistema_telefone_movel; ?>">
                     <?php echo form_error('sistema_telefone_movel', '<small class="form-text text-danger">','</small>'); ?>
                  </div>

                  <div class="col-md-3">
                     <label>Email:</label>
                     <input type="email" class="form-control" name="sistema_email" placeholder="Email" value="<?php echo $sistema->sistema_email; ?>">
