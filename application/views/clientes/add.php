          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="user" method="POST" name="form_add">
                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                       ...
                       <input type="date" class="form-control form-control-date" name="cliente_data_nascimento" placeholder="Data Nascimento" value="<?php echo set_value('cliente_data_nascimento'); ?>">
                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-3">
                       ...
                       <input type="text" class="form-control" name="cliente_numero_endereco" placeholder="Número Endereço:" value="<?php echo set_value('cliente_numero_endereco'); ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-2">
                       <label>UF:</label>
                       <input type="text" class="form-control" name="cliente_estado" placeholder="UF" value="<?php echo set_value('cliente_estado'); ?>">
                ...
                <a href="<?php echo base_url('clientes'); ?>" class="btn btn-success btn-sm ml-2"><i class="fas fa-arrow-left"></i>&nbsp;Voltar</a>
              </form>
            </div>
          </div>
        </div>
