                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                       ...
                       <input type="date" class="form-control form-control-date" name="cliente_data_nascimento" placeholder="Data Nascimento" value="<?php echo $cliente->cliente_data_nascimento; ?>">
                  ...
                  <div class="form-group row">
                   <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                       ...
                       <input type="text" class="form-control" name="cliente_rg_ie" placeholder="<?php echo ($cliente->cliente_tipo == 1 ? 'RG Do Cliente' : 'I.E Do Cliente') ?>" value="<?php echo $cliente->cliente_rg_ie; ?>">
